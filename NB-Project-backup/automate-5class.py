...
node = 'node -r esm ./build/automation/typescript/automation/Classify5.js "https://ropsten.infura.io/v3/0337bb9e0a074dfd8de737681ba9eead" "grit start safe lonely dirt palace short judge quiz process tomorrow avoid" "feature-5class.txt" "predicted-5class.txt" "5class-gasuse" "time-5class"'
file1 = open('class5_File.txt', 'r')
Lines = file1.readlines()
step =6
for i in range(0, len(Lines), 6):
    file2 =open('feature-5class.txt','w')
