...
contract BinaryClass{
    ...
    int c10;int c20;int c30;int c40;int c50;int c60;int c70;
    int c11;int c21;int c31;int c41;int c51;int c61;int c71;
    int V10; int V20; int V30; int V40; int V50; int V60; int V70;
    int V11; int V21; int V31; int V41; int V51; int V61; int V71;
    
    function variance0
        (
        int v1,int v2, int v3,int v4,int v5,int v6,int v7
        )public{
        B0 = v1*v2*v3*v4*v5*v6*v7;
        D0 = B0;
    ...
    function c_getparameters1
        (
        int x1,int x2, int x3,int x4,int x5,int x6,int x7,int m1,int m2, int m3,int m4, int m5, int m6, int m7
        ) public {
     ...
     function v1_multiply(int v1,int v2,int v3,int v4,int v5, int v6, int v7) public {
         V10 = c10*v2*v3*v4*v5*v6*v7;
         V20 = v1*c20*v3*v4*v5*v6*v7;
         V30 = v1*v2*c30*v4*v5*v6*v7;
         V40 = v1*v2*v3*c40*v5*v6*v7;
         V50 = v1*v2*v3*v4*c50*v6*v7;
         V60 = v1*v2*v3*v4*v5*c60*v7;
         V70 = v1*v2*v3*v4*v5*v6*c70;
         
     }
     function v2_multiply(int v1,int v2,int v3,int v4,int v5, int v6, int v7) public {
         V11 = c11*v2*v3*v4*v5*v6*v7;
         V21 = v1*c21*v3*v4*v5*v6*v7;
         V31 = v1*v2*c31*v4*v5*v6*v7;
         V41 = v1*v2*v3*c41*v5*v6*v7;
         V51 = v1*v2*v3*v4*c51*v6*v7;
         V61 = v1*v2*v3*v4*v5*c61*v7;
         V71 = v1*v2*v3*v4*v5*v6*c71;
         
     }
     function C_get(
        ) public {
         C0 =V10+V20+V30+V40+V50+V60+V70;
         C1 =V11+V21+V31+V41+V51+V61+V71;
