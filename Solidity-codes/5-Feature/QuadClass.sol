...
contract QuadClass{
    ...
    int A2; int B2; int C2; int D2; int A3; int B3; int C3; int D3; int P2;int P3;
    int Y0; int Y1;
    ...
    function test(int Prior0, int Prior1, int Prior2, int Prior3)public{
    ...
    function f_compare()public view returns(int){
        ...
        if(P0 > P1 && P0 >P2 && P0>P3)return(p0);
        else if (P1 > P2 && P1 > P0 && P1>P3)return(p1);
        else if (P2 > P0 && P2 > P1 && P2> P3)return(p2);
        else return(p3);
    }
}
