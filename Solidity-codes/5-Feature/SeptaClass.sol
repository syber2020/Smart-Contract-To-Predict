...
contract SeptaClass{
    ...
    int A2; int B2; int C2; int D2; int A3; int B3; int C3; int D3;
    int A4; int B4; int C4; int D4;int A5;int B5; int C5; int D5;int A6; int B6; int C6;int D6;
    int P0;int P1;int P2;int P3;int P4;int P5;int P6;
    int Y0;int Y1;int a;int b;int c;int d;int c1;int c2;int c3;int c4;
    ...
    function b_getparameters6(
        ...
        c3 = (x3-m3)*(x3-m3);
        c4 =(x4-m4)*(x4-m4);
        C6 = c1*v2*v3*v4 + c2*v1*v3*v4 + c3*v1*v2*v4 + c4*v1*v2*v3;
    }
    ...
    function d_printparamaters6() public view returns(int,int,int,int){
        return(A6,B6,C6,D6);
    }
    ...
    function test(int Prior0, int Prior1, int Prior2, int Prior3, int Prior4, int Prior5,int Prior6)public{
        ...
        if(P0>P1 && P2>P3 && P4>P5){        // P0,P2,P4{
            ...
            if(Y0>Y1){P2=1;  //compare P0 and P4
                e_exponent(A0,A4,B0,B4,C0,C4,D0,D4,Prior0, Prior4);
                if(Y0>Y1){P4=1;
					e_exponent(A0,A6,B0,B6,C0,C6,D0,D6,Prior0, Prior6);
					P0=Y0; P6=Y1;
				}else{ P0=1;
					e_exponent(A4,A6,B4,B6,C4,C6,D4,D6,Prior4, Prior6);
					P4=Y0; P6=Y1;
				}
			}
            else{P0=2;
                ...
                if(Y0>Y1){P4=2;
					e_exponent(A2,A6,B2,B6,C2,C6,D2,D6,Prior2, Prior6);
					P2=Y0; P6=Y1;
				}else{P2=2;
					e_exponent(A4,A6,B4,B6,C4,C6,D4,D6,Prior4, Prior6);
					P4=Y0; P6=Y1;
            ...
            e_exponent(A0,A2,B0,B2,C0,C2,D0,D2,Prior0, Prior2);
            if(Y0>Y1){P2=3;  //compare P0 and P5
                e_exponent(A0,A5,B0,B5,C0,C5,D0,D5,Prior0, Prior5);
                if(Y0>Y1){P5=3;
					e_exponent(A0,A6,B0,B6,C0,C6,D0,D6,Prior0, Prior6);
					P0=Y0; P6=Y1;
				}else{ P0=3;
					e_exponent(A5,A6,B5,B6,C5,C6,D5,D6,Prior5, Prior6);
					P5=Y0; P6=Y1;
				}
			}
            else{P0=4;
            ...
            if(Y0>Y1){P3=5;  //compare P0 and P4
                e_exponent(A0,A4,B0,B4,C0,C4,D0,D4,Prior0, Prior4);
                if(Y0>Y1){P4=5;
					e_exponent(A0,A6,B0,B6,C0,C6,D0,D6,Prior0, Prior6);
					P0=Y0; P6=Y1;
                ...
                if(Y0>Y1){P4=6;
					e_exponent(A3,A6,B3,B6,C3,C6,D3,D6,Prior3, Prior6);
					P3=Y0; P6=Y1;
				}else{P3=6;
					e_exponent(A4,A6,B4,B6,C4,C6,D4,D6,Prior4, Prior6);
					P4=Y0; P6=Y1;
            ...
            e_exponent(A0,A3,B0,B3,C0,C3,D0,D3,Prior0, Prior3);
            if(Y0>Y1){P3=7;  //compare P0 and P4
                e_exponent(A0,A5,B0,B5,C0,C5,D0,D5,Prior0, Prior5);
                if(Y0>Y1){P5=7;
					e_exponent(A0,A6,B0,B6,C0,C6,D0,D6,Prior0, Prior6);
					P0=Y0; P6=Y1;
            ...
            if(Y0>Y1){P2=9;  //compare P0 and P4
                e_exponent(A1,A4,B1,B4,C1,C4,D1,D4,Prior1, Prior4);
                if(Y0>Y1){P4=9;
					e_exponent(A1,A6,B1,B6,C1,C6,D1,D6,Prior1, Prior6);
					P1=Y0; P6=Y1;
				}else{ P1=9;
					e_exponent(A4,A6,B4,B6,C4,C6,D4,D6,Prior4, Prior6);
					P4=Y0; P6=Y1;
            ...
            e_exponent(A1,A2,B1,B2,C1,C2,D1,D2,Prior1, Prior2);
            if(Y0>Y1){P2=11;  //compare P0 and P4
            ...
            if(Y0>Y1){P3=13;  //compare P0 and P4
                e_exponent(A1,A4,B1,B4,C1,C4,D1,D4,Prior1, Prior4);
                if(Y0>Y1){P4=13;
					e_exponent(A1,A6,B1,B6,C1,C6,D1,D6,Prior1, Prior6);
					P1=Y0; P6=Y1;
            ...
            e_exponent(A1,A3,B1,B3,C1,C3,D1,D3,Prior1, Prior3);
            if(Y0>Y1){P3=15;  //compare P0 and P4
                e_exponent(A1,A5,B1,B5,C1,C5,D1,D5,Prior1, Prior5);
                if(Y0>Y1){P5=15;
					e_exponent(A1,A6,B1,B6,C1,C6,D1,D6,Prior1, Prior6);
					P1=Y0; P6=Y1;
    ...
    function printall() public view returns(int,int,int,int,int,int,int){ return(P0,P1,P2,P3,P4,P5,P6);}
    function f_compare()public view returns(int){
        int p0=0; int p1=1; int p2=2; int p3=3; int p4=4;int p5=5;int p6=6;
        if(P0>P1 && P0>P2 && P0>P3 && P0>P4 && P0>P5 && P0>P6)return(p0);
        else if (P1>P2 && P1>P0 && P1>P3 && P1>P4 && P1>P5 && P1>P6)return(p1);
        else if (P2>P0 && P2>P1 && P2>P3 && P2>P4 && P2>P5 && P2>P6)return(p2);
        else if (P3>P0 && P3>P1 && P3>P2 && P3>P4 && P3>P5 && P3>P6)return(p3);
        else if (P4>P0 && P4>P1 && P4>P2 && P4>P3 && P4>P5 && P4>P6)return(p4);
		else if (P5>P0 && P5>P1 && P5>P2 && P5>P3 && P5>P4 && P5>P6)return(p5);
        else return(p6);
    }
}
