...
contract PentaTest{
   ...
   int X01; int X23; int X45;int Y0;int A5;int B5; int C5; int D5;uint[] divisor;

       int c5;
    int x;int y;
    function a_getparameters1
        (
        int x1,int x2, int x3,int x4,int x5,int v1,int v2, int v3,int v4,int v5,int m1,int m2, int m3,int m4, int m5
        ) public {
        A0 = 1;
        B0 = int(v1*v2*v3*v4*v5);
        D0 = int(v1*v2*v3*v4*v5);
        c1 = (x1-m1); c1=c1*c1;
        c2= (x2-m2); c2=c2*c2;  
        c3 = (x3-m3); c3=c3*c3; 
        c4 =(x4-m4);c4=c4*c4;
        c5 =(x5-m5);c5=c5*c5;
        C0 =int(c1*v2*v3*v4*v5 + c2*v1*v3*v4*v5 + c3*v1*v2*v4*v5 + c4*v1*v2*v3*v5 + c5*v1*v2*v3*v4 );
    }
    ...
    function a_getparameters2
        ...
        A1 = 1;
        B1 = int(v1*v2*v3*v4*v5);
        D1 = int(v1*v2*v3*v4*v5);
        c1 = (x1-m1); c1=c1*c1;
        c2= (x2-m2); c2=c2*c2;  
        c3 = (x3-m3); c3=c3*c3; 
        c4 =(x4-m4);c4=c4*c4;
        c5 =(x5-m5);c5=c5*c5;
        C1 =int(c1*v2*v3*v4*v5 + c2*v1*v3*v4*v5 + c3*v1*v2*v4*v5 + c4*v1*v2*v3*v5 + c5*v1*v2*v3*v4 );
    }
    function a_getparameters3
        ...
        A2 = 1;
        B2 = int(v1*v2*v3*v4*v5);
        D2 = int(v1*v2*v3*v4*v5);
        c1 = (x1-m1); c1=c1*c1;
        c2= (x2-m2); c2=c2*c2;  
        c3 = (x3-m3); c3=c3*c3; 
        c4 =(x4-m4);c4=c4*c4;
        c5 =(x5-m5);c5=c5*c5;
        C2 =int(c1*v2*v3*v4*v5 + c2*v1*v3*v4*v5 + c3*v1*v2*v4*v5 + c4*v1*v2*v3*v5 + c5*v1*v2*v3*v4 );
    }
    function a_getparameters4
        ...
        A4 = 1;
        B4 = int(v1*v2*v3*v4*v5);
        D4 = int(v1*v2*v3*v4*v5);
        c1 = (x1-m1); c1=c1*c1;
        c2= (x2-m2); c2=c2*c2;  
        c3 = (x3-m3); c3=c3*c3; 
        c4 =(x4-m4);c4=c4*c4;
        c5 =(x5-m5);c5=c5*c5;
        C4 =int(c1*v2*v3*v4*v5 + c2*v1*v3*v4*v5 + c3*v1*v2*v4*v5 + c4*v1*v2*v3*v5 + c5*v1*v2*v3*v4 );
    }
    function a_getparameters5
        ...
        A3 = 1;
        B3 = int(v1*v2*v3*v4*v5);
        D3 = int(v1*v2*v3*v4*v5);
        c1 = (x1-m1); c1=c1*c1;
        c2= (x2-m2); c2=c2*c2;  
        c3 = (x3-m3); c3=c3*c3; 
        c4 =(x4-m4);c4=c4*c4;
        c5 =(x5-m5);c5=c5*c5;
        C3 =int(c1*v2*v3*v4*v5 + c2*v1*v3*v4*v5 + c3*v1*v2*v4*v5 + c4*v1*v2*v3*v5 + c5*v1*v2*v3*v4 );
    }
    ...
    int z; int gcdint;  uint max;
        if(a>b){z=b;} else {z=a;}
        for (int i=1;i<=z;i++){
            if(a%i==0&&b%i==0){ 
                gcdint=i;
                divisor.push(uint(gcdint));
            }
        }
        
        for (uint i =0; i <divisor.length;i++){
